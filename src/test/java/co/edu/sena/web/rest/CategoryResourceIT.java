...
class CategoryResourceIT {
    ...
    private static final State DEFAULT_STATE_CATEGORY = State.ACTIVE;
    private static final State UPDATED_STATE_CATEGORY = State.INACTIVE;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).stateCategory(DEFAULT_STATE_CATEGORY);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).stateCategory(UPDATED_STATE_CATEGORY);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getStateCategory()).isEqualTo(DEFAULT_STATE_CATEGORY);
    }
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].stateCategory").value(hasItem(DEFAULT_STATE_CATEGORY.toString())));
    }
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.stateCategory").value(DEFAULT_STATE_CATEGORY.toString()));
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).stateCategory(UPDATED_STATE_CATEGORY);
        ...
        assertThat(testCategory.getStateCategory()).isEqualTo(UPDATED_STATE_CATEGORY);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).stateCategory(UPDATED_STATE_CATEGORY);
