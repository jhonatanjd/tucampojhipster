...
/**
 * REST controller for managing {@link co.edu.sena.domain.Driver}.
 */
@RestController
@RequestMapping("/api")
public class DriverResource {
    ...
    public ResponseEntity<List<DriverDTO>> getAllDrivers(
        ...
        if ("vehicle-is-null".equals(filter)) {
            log.debug("REST request to get all Drivers where vehicle is null");
            return new ResponseEntity<>(driverService.findAllWhereVehicleIsNull(), HttpStatus.OK);
        }
