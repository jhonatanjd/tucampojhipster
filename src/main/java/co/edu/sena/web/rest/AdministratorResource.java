...
/**
 * REST controller for managing {@link co.edu.sena.domain.Administrator}.
 */
@RestController
@RequestMapping("/api")
public class AdministratorResource {
    ...
    public ResponseEntity<List<AdministratorDTO>> getAllAdministrators(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
