...
import co.edu.sena.service.SaleService;
...
/**
 * REST controller for managing {@link co.edu.sena.domain.Sale}.
 */
@RestController
@RequestMapping("/api")
public class SaleResource {
     ...
     */
    @GetMapping("/sales")
    public ResponseEntity<List<SaleDTO>> getAllSales(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
