...
import co.edu.sena.repository.ProductsRepository;
import co.edu.sena.service.ProductsService;
...
/**
 * REST controller for managing {@link co.edu.sena.domain.Products}.
 */
@RestController
@RequestMapping("/api")
