...
export class SaleComponent implements OnInit {
  ...
  trackId(_index: number, item: ISale): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ISale[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
