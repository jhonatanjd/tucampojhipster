...
describe('WayToPay Management Component', () => {
  let comp: WayToPayComponent;
  let fixture: ComponentFixture<WayToPayComponent>;
  let service: WayToPayService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'way-to-pay', component: WayToPayComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(WayToPayComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.wayToPays?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
