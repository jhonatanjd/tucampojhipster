...
export class AnonymousComponent implements OnInit {
  ...
  trackId(_index: number, item: IAnonymous): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAnonymous[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
