...
export class AdministratorComponent implements OnInit {
  ...
  trackId(_index: number, item: IAdministrator): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IAdministrator[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
