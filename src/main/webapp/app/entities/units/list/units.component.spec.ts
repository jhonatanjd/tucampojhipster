...
describe('Units Management Component', () => {
  let comp: UnitsComponent;
  let fixture: ComponentFixture<UnitsComponent>;
  let service: UnitsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'units', component: UnitsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(UnitsComponent, '')
      .compileComponents();
