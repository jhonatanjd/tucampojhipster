...
describe('Producer Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'producer', component: ProducerComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.producers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
